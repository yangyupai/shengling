...
public class Cards {
    ...
    static {
        initData = new ArrayList<String>() {{
            add("1001,xiaoming,badlogic.jpg,10,5");
            add("1002,xiaohong,badlogic.jpg,5,8");
            add("1003,xiaogang,badlogic.jpg,20,2");
            add("1004,xiaojun,badlogic.jpg,7,7");
            add("1005,xiaoqiang,badlogic.jpg,1,1");
            add("1006,xiaoliang,badlogic.jpg,2,2");
            add("1007,xiaowang,badlogic.jpg,4,5");
            add("1008,xiaozhao,badlogic.jpg,7,8");
            add("1009,xiaoma,badlogic.jpg,2,10");
            add("1010,xiaozhang,badlogic.jpg,30,15");
        }};
    }
